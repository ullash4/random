...
const Header = () => {
    return (
      <nav className="sticky top-0 navbar navbar-expand-lg shadow-md py-2 bg-white  flex items-center w-full justify-between ">
        ...
        <div className="navbar-collapse collapse grow items-center" id="navbarSupportedContentY">
          <ul className="navbar-nav mr-auto lg:flex lg:flex-row">
            <li className="nav-item">
              <Link className="nav-link block pr-2 lg:px-2 py-2 text-gray-600 hover:text-gray-700 focus:text-gray-700 transition duration-150 ease-in-out"
                to={"/"} data-mdb-ripple="true" data-mdb-ripple-color="light">Home</Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link block pr-2 lg:px-2 py-2 text-gray-600 hover:text-gray-700 focus:text-gray-700 transition duration-150 ease-in-out"
                to="/cinematography" data-mdb-ripple="true" data-mdb-ripple-color="light">Cinematography</Link>
            </li>
            <li className="nav-item">
